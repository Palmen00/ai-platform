...
from app.services.logging_service import read_recent_events, read_recent_log_lines
...
def get_logs(
    ...
    return LogsResponse(
        events=read_recent_events(limit=event_limit),
        raw_lines=read_recent_log_lines(limit=line_limit),
    )
